...
public class CompUseEffectLootBoxTreasure : CompUseEffectLootBox
{
    ...
    {
        new(7, new Reward("Gold", 3, 6, 17)),
        new(5, new Reward("Gold", 7, 15, 35)),
        new(4, new Reward("Silver", 50, 90, 600)),
        new(4, new Reward("Jade", 7, 13, 30)),
        new(4, new Reward("LootBoxSilverSmall")),
        new(3, new Reward("ElephantTusk", rand: 3)),
        new(3, new Reward("Gold", 5, 10, 25), new Reward("Jade", 5, 10, 25)),
        new(3, new Reward("Hyperweave", 4, 7, 20)),
        new(2, new Reward("LootBoxTreasure")),
        new(2, new Reward("Silver", 40, 80, 220), new Reward("Gold", 8, 15, 40)),
        new(2, new Reward("LootBoxPandora")),
        new(1, new Reward("Gold", 10, 20, 140)),
        new(1, new Reward("LootBoxGoldSmall")),
        new(1, new Reward("ThrumboHorn"))
    };
}